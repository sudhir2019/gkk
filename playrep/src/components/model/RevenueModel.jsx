...
const RevenueModel = ({ modelData, isOpen, onClose }) => {
            ...
            <div className="popup-modal">
                <div className="table_formatting">
                    ...
                    <div className="DetailsDiv">
                        <p>In this week your revenue is at <span style={{ color: '#CC3300' }}>{totals?.totalProfit < 0 ? 0 : totals?.totalRevenuePercentage}%</span></p>
                        <p>Due to earning in this week, the company would able to provide you <span style={{ color: '#CC3300' }}>

                            {totals?.totalProfit < 0 ? "0" : totals?.totalProfit * totals?.totalRevenuePercentage / 100}
