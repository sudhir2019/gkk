...
import { fetchTurnOverReport } from '../../../stores/actions/reportActions';
import { useLocation, useParams } from 'react-router-dom';
import TurnoverReportTable from '../../../components/TablesComponents/TurnoverReportTable';
...
function TurnOverReport() {
    ...
    useEffect(() => {
        dispatch(fetchTurnOverReport({ role, id, startDate, endDate })).unwrap();
    }, []);

    const { turnoverdata, roles } = useSelector((state) => state.reports);
            ...
            <div className="col-md-12 grid-margin stretch-card">
                <div className="card">
                                ...
                                <table className="table table-bordered text-center data-table-top">
                                    <thead>
                                        <tr>
                                            ...
                                            <td className="bg-gradient-warning text-white">Total Commission</td>
                                    ...
                                    <tbody>
                                        {
                                            turnoverdata && turnoverdata.length > 0 && (() => {
                                                ...
                                                turnoverdata.forEach((obj) => {
                                                    play += parseFloat(obj.playPoints) || 0;
                                                    win += parseFloat(obj.winPoints) || 0;
                                                    com += parseFloat(obj.supercom) + parseFloat(obj.distcom) + parseFloat(obj.retailcom);
                                                });

                                                end = play - win;  // Calculate End Points
                                                net = end - com;   // Calculate Net
                    ...
                    <div className='row m-2'>
                        ...
                        <div className='card-body'>
                            <TurnoverReportTable data={turnoverdata} startDate={startDate} endDate={endDate} />
                        </div>
