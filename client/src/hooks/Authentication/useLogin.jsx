...
export default function useLogin() {
    ...
    let { isLoading, serverError } = useSelector((state) => state.auth);
        ...
        try {
            ...
            setTimeout(() => {
                const rolePathMap = {
                    ...
                    superdistributor: "/superareamanager/dashboard",
                    distributor: "/areamanager/dashboard",
                    retailer: "/master/dashboard",
                    user: "/",
                };
                ...
                if (response.roles) {
                    navigate(rolePathMap[response.roles.toLowerCase()]);
                    // console.log(rolePathMap[response.roles.toLowerCase
