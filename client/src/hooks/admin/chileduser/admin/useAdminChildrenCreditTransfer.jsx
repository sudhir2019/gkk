...
import { creditTransferToChild } from "../../../../stores/actions/adminActions";
import { useState, useEffect } from 'react';
import { getUserByIdAsync } from '../../../../stores/actions/authActions';
import { loadcredit } from '../../../../stores/actions/creditActions';
import useFetchAdminchildrenById from "./useFetchAdminchildrenById";

export default function useAdminChildrenCreditTransfer({ any, id }) {
    const dispatch = useDispatch();
    const { childrenInfo } = useFetchAdminchildrenById({ any, id });
