...
import { createAdminChild } from "../../../../stores/actions/adminActions";
import useFetchAllAdmins from "../../users/admin/useFetchAllAdmins";
import { Country, State, City } from "country-state-city";

const useCreateAdminChildren = (adminParent) => {
    ...
    const onSubmit = async (childAdminData) => {
        ...
        try {
            await dispatch(createAdminChild({ childAdminData, parentAdminId })).unwrap();
...
export default useCreateAdminChildren;
