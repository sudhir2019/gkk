...
import { creditTransferToChild } from "../../../../stores/actions/distributorAction";
...
export default function useDistributorChildrenCreditTransfer({ any, id }) {
    const dispatch = useDispatch();
    const { childrenInfo } = useFetchDistributorchildrenById({ any, id });
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const response = await dispatch(creditTransferToChild({ parentdistributorId, superdistributorsId, transferData })).unwrap();
            ...
            setShowCreditError(childrenError);
        } finally {
