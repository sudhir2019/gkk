...
import useFetchDistributorchildrenById from "./useFetchDistributorchildrenById";
import { updatedistributorChild } from '../../../../stores/actions/distributorAction';
import useFetchAllDistributor from '../../users/distributors/useFetchAllDistributor';

const useUpdateDistributoesChildren = ({ any, id }) => {
    const dispatch = useDispatch();
    const { childrenInfo } = useFetchDistributorchildrenById({ any, id });  // Fetch SuperDistributors data
    ...
    useEffect(() => {
        if (childrenInfo) {
            ...
            reset({
                ...
                commission: childrenInfo.commission ?? 0,
    ...
    const onSubmit = async () => {
        ...
        try {
            await dispatch(updatedistributorChild({ parentAdminId, superdistributorsId, updatedFields })).unwrap();
...
export default useUpdateDistributoesChildren;
