...
import { creditTransferToChild } from "../../../../stores/actions/retailerAction";
...
export default function useRetailerChildrenCreditTransfer({ any, id }) {
    const dispatch = useDispatch();
    const { childrenInfo } = useFetchRetailerchildrenById({ any, id });
