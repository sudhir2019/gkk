...
import { createsuperdistributorsChild } from "../../../../stores/actions/superDistributorAction";
import useFetchAllSuperDistributors from "../../users/superdistributors/useFetchAllSuperDistributor";
import { Country, State, City } from "country-state-city";
const useCreateSuperDistributoesChildren = (adminParent) => {
    const dispatch = useDispatch();
    const navigate = useNavigate();
    const { superdistributors } = useFetchAllSuperDistributors();
    ...
    const onSubmit = async (childAdminData) => {
        ...
        try {
            await dispatch(createsuperdistributorsChild({ childAdminData, parentAdminId })).unwrap();
...
export default useCreateSuperDistributoesChildren;
