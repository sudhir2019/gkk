...
import { deleteChild } from "../../../../stores/actions/superDistributorAction";

const useDeleteSuperDistributorChildren = (closeModal) => {
...
export default useDeleteSuperDistributorChildren;
