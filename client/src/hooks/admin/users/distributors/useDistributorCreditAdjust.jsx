...
import { creditAdjust } from "../../../../stores/actions/distributorAction";
...
export default function useDistributorsCreditAdjust(id) {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const errorMessage = distributorsError || err?.response?.data?.message || err?.message || "An error occurred.";
