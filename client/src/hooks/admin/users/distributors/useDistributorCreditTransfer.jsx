...
import { creditTransfer } from "../../../../stores/actions/distributorAction";
...
export default function useDistributorsCreditTransfer(id) {
    const dispatch = useDispatch();
    const { distributor } = useFetchDistributorsById(id);
    ...
    const { DistributorsError } = useSelector((state) => state.superdistributor);
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const errorMessage = DistributorsError || err?.message || "Unknown error occurred during credit transfer.";
