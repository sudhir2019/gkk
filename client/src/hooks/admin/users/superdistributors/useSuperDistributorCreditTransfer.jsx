...
import { creditTransfer } from "../../../../stores/actions/superDistributorAction";
...
export default function useSuperDistributorsCreditTransfer(id) {
    const dispatch = useDispatch();
    const { superdistributor } = useFetchSuperDistributorsById(id);
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const errorMessage = superdistributorsError || err?.message || "Unknown error occurred during credit transfer.";
