...
import { creditAdjust } from "../../../../stores/actions/superDistributorAction";
...
export default function useSuperDistributorsCreditAdjust(id) {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const errorMessage = superdistributorsError || err?.response?.data?.message || err?.message || "An error occurred.";
