...
import useFetchSuperDistributorsById from "./useFetchSuperDistributorById";
import { updatesuperdistributors } from '../../../../stores/actions/superDistributorAction';
import useFetchAllAdmins from '../admin/useFetchAllAdmins';
import { Country, State, City } from "country-state-city";
import { useEffect, useState, useMemo } from 'react';

const useUpdateSuperDistributors = (superdistributorsId) => {
    const dispatch = useDispatch();
    const { superdistributor } = useFetchSuperDistributorsById(superdistributorsId);  // Fetch SuperDistributors data
    ...
    const onSubmit = async () => {
        ...
        try {
            await dispatch(updatesuperdistributors({ superdistributorsId, updatedFields })).unwrap();
...
export default useUpdateSuperDistributors;
