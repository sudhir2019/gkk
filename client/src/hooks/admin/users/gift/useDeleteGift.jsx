...
import { deleteusers } from "../../../../stores/actions/giftActions";

const useDeleteGifts = (closeModal) => {
    ...
    const deleteUser = useCallback(
        async (userId) => {
            ...
            try {
                ...
                setDeleteLoading(false);
                const deleteError = giftError || err.message || "Failed to delete player.";
