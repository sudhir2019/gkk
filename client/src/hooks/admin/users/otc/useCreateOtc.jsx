...
import { createusers } from "../../../../stores/actions/otcActions";
...
const useCreateOtc = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const UsresCreateError = otcError || err?.response?.data?.message || err?.message || "Failed to create superretailers.";
