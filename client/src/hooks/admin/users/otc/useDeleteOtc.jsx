...
import { deleteusers } from "../../../../stores/actions/otcActions";

const useDeleteOtc = (closeModal) => {
    ...
    const deleteUser = useCallback(
        async (userId) => {
            ...
            try {
                ...
                setDeleteLoading(false);
                const deleteError = otcError || err.message || "Failed to delete player.";
