...
import { creditTransfer, loadcredit } from "../../../../stores/actions/loanActions";
import { useState, useEffect } from 'react';
import useFetchUsersById from "./useFetchLoanById";


export default function useLoanCreditTransfer(id) {
    const dispatch = useDispatch();
    const { loan } = useFetchUsersById(id);
    ...
    const { loanError, senderAmount } = useSelector((state) => state.gift);
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const errorMessage = loanError || err?.message || "Unknown error occurred during credit transfer.";
