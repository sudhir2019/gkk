...
import { deleteusers } from "../../../../stores/actions/loanActions";

const useDeleteLoans = (closeModal) => {
    ...
    const deleteUser = useCallback(
        async (userId) => {
            ...
            try {
                ...
                setDeleteLoading(false);
                const deleteError = loanError || err.message || "Failed to delete player.";
