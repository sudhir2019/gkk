...
import { createusers } from "../../../../stores/actions/loanActions";
import useFetchAllAdmins from "../admin/useFetchAllAdmins";
import { Country, State, City } from "country-state-city";

const useCreateLoans = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const UsresCreateError = loanError || err?.response?.data?.message || err?.message || "Failed to create superretailers.";
