...
import { toggleUserStatus } from '../../../../stores/actions/loanActions'; // Adjust the path as needed

export default function useActivateLoan(closeModal) {
    ...
    const activateUsers = useCallback(
        async (userId, action) => {
            ...
            try {
                ...
                const stateError = loanError || err.message || 'Failed to update user status.'
