...
const RetailerDataTable = ({ retailers, openModal, handleActivateDeactivate, handleDelete }) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            width: '150px',
            selector: row => (
                <Link to={`../master/players/details/${row._id}`} className="text-decoration-none">
    ...
    const handleExport = () => {
        const exportData = retailers.map(distributer => ({
    ...
    return (
        <div className="container-fluid">
            ...
            <div className="table-responsive">
                <DataTable
                    columns={columns}
                    data={retailers} // Use the correct data prop here
