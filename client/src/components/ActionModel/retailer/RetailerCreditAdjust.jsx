...
import useRetailersCreditAdjust from "../../../hooks/admin/users/retailers/useRetailersCreditAdjust";
import { ScaleLoader } from "react-spinners";

export default function RetailerCreditAdjust() {
    const { any } = useParams();
    const {
        register,
        handleSubmit,
