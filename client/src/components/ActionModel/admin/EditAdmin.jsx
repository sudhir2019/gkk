...
import useUpdateAdmin from "../../../hooks/admin/users/admin/useUpdateAdmin";
            ...
            <div className="col-md-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-body">
                        <h6 className="card-title">Edit Admin</h6>
                                        ...
                                        <div className="d-flex flex-wrap">
                                            {games?.map((game) => (
                                                <label key={game._id} className="mr-3">
                                                    <input type="checkbox" {...register("games")} value={game._id} /> {game.gameName}
                                                </label>
                                            ))}
                                        </div>
                                    </div>
