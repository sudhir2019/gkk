...
import useCreateAdmin from "../../../hooks/admin/users/admin/useCreateAdmin";
            ...
            <div className="col-md-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-body">
                        <h6 className="card-title">Add Admin</h6>
                                ...
                                <div className="col-sm-6">
                                    <div className="form-group">
                                        ...
                                        <select className="form-control" {...register("refId", { required: "Reference is required" })}>
                                            ...
                                            {superadmins?.length > 0 ? superadmins.map((obj) => (
                                        ...
                                        <div className="d-flex flex-wrap">
                                            <Controller
                                                ...
                                                render={({ field }) => (
                                                    <>
                                                        {games.map((game) => (
                                                            <label key={game._id} className="mr-3">
                                                                <input
                                                                    type="checkbox"
                                                                    value={game._id}
                                                                    checked={field.value?.includes(game._id)}
                                                                    onChange={(e) => {
                                                                        const newValue = e.target.checked
                                                                            ? [...(field.value || []), game._id]
                                                                            : field.value.filter((id) => id !== game._id);
