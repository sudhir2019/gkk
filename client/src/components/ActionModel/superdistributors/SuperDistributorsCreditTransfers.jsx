...
import useSuperDistributorsCreditTransfer from "../../../hooks/admin/users/superdistributors/useSuperDistributorCreditTransfer"; // Adjust path as necessary
import { ScaleLoader } from "react-spinners"
export default function SuperDistributorsCreditTransfers() {
    const { any } = useParams();
    const {
        register,
        handleSubmit,
        ...
        errors,
        credit
    } = useSuperDistributorsCreditTransfer(any);
            ...
            <div className="col-md-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-header">
                        <h6>Super Area Manager Credit Transfer</h6>
                    </div>
                    <div className="card-body">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="form-group d-flex">
                                <div className="col-sm-4 offset-lg-3">
                                    <h4 className="breadcrumb bg-slate-700 text-white">User: {superdistributor?.username || ""}</h4>
                                    <br />
                                    <h4 className="breadcrumb  bg-slate-700 text-white">
                                        Individual Credit: {(superdistributor?.walletBalance || 0).toFixed(2)}
                                    </h4>
                                    <br />
                                    <h4 className="breadcrumb  bg-slate-700 text-white">
