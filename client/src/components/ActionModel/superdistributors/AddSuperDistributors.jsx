import useCreateSuperDistributors from "../../../hooks/admin/users/superdistributors/useCreateSuperDistributor";
import { ScaleLoader } from "react-spinners";
import { useNavigate } from "react-router-dom";

export default function AddSuperDistributors() {
    const {
        register,
        admins,
        handleSubmit,
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-6">
                                    <div className="form-group">
                                        ...
                                        />
                                        {errors.commissionAmount && <p className="text-danger">{errors.commissionAmount.message}</p>}
                                    </div>
                                </div>
                                {/* Occupation */}
                                {/* <div className="col-sm-6">
                                ...
                                <div className="col-sm-6">
                                    <div className="form-group">
                                        ...
                                        <select className="form-control" {...register("refId", { required: "Reference is required" })}>
                                            ...
                                            {admins?.length > 0 ? admins.map((obj) => (
