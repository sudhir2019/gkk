...
import useSuperDistributorsCreditAdjust from "../../../hooks/admin/users/superdistributors/useSuperDistributorCreditAdjust";
import { ScaleLoader } from "react-spinners";

export default function SuperDistributorsCreditAdjust() {
    const { any } = useParams();
    const {
        register,
        handleSubmit,
        ...
        superdistributor,
        credit
    } = useSuperDistributorsCreditAdjust(any);
            ...
            <div className="col-md-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-header">
                        <h6>Super Area Manager Credit Adjust</h6>
                    </div>
