...
import useUpdateSuperDistributors from "../../../hooks/admin/users/superdistributors/useUpdateSuperDistributor";
import { ScaleLoader } from "react-spinners";

export default function EditSuperDistributors() {
    ...
    const {
        ...
        states,
        cities,
    } = useUpdateSuperDistributors(any);
    return (
        <div className="row">
            <div className="col-md-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-body">
                        <h6 className="card-title">Edit Super Area Manager</h6>
