...
import useDistributorCreditAdjust from "../../../hooks/admin/users/distributors/useDistributorCreditAdjust";
import { ScaleLoader } from "react-spinners";

export default function DistributorsCreditAdjust() {
    const { any } = useParams();
    ...
    const {
        ...
        distributor,
        credit
    } = useDistributorCreditAdjust(any);
            ...
            <div className="col-md-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-header">
                        <h6>Area Manager Credit Adjust</h6>
                    </div>
