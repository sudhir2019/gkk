import useCreatedistributors from "../../../hooks/admin/users/distributors/useCreateDistributor";
            ...
            <div className="col-md-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-body">
                        <h6 className="card-title">Add Area Managers</h6>
