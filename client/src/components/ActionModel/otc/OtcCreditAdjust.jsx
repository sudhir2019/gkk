...
import useUsersCreditAdjust from "../../../hooks/admin/users/otc/useOtcCreditAdjust";
import { ScaleLoader } from "react-spinners";

export default function OtcCreditAdjust() {
    const { any } = useParams();
    const {
        register,
        handleSubmit,
            ...
            <div className="col-md-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-header">
                        <h6>OTC Credit Adjust</h6>
                    </div>
                    <div className="card-body">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="form-group d-flex">
                                <div className="col-sm-4 offset-lg-3">
                                    <h4 className="breadcrumb bg-slate-700 text-white">gift: {otc?.username || ""}</h4>
                                    <br />
