...
import useUsersCreditTransfer from "../../../hooks/admin/users/gift/useGiftsCreditTransfer"; // Adjust path as necessary
import { ScaleLoader } from "react-spinners"
export default function GiftCreditTransfers() {
    const { any } = useParams();
    const {
        register,
        handleSubmit,
            ...
            <div className="col-md-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-header">
                        <h6>Gift Credit Transfer</h6>
                    </div>
                    <div className="card-body">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="form-group d-flex">
                                <div className="col-sm-4 offset-lg-3">
                                    <h4 className="breadcrumb bg-slate-700 text-white">User: {gift?.username || ""}</h4>
                                    <br />
                                    <h4 className="breadcrumb  bg-slate-700 text-white">
                                        Individual Credit: {(gift?.walletBalance || 0).toFixed(2)}
                                    </h4>
                                    <br />
                                    <h4 className="breadcrumb  bg-slate-700 text-white">
