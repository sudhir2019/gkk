...
import useRetailerChildrenCreditTransfer from "../../../hooks/admin/chileduser/retailers/useRetailerChildrenCreditTransfer"; // Adjust path as necessary
import { ScaleLoader } from "react-spinners"
export default function RetailerChildrenCreditTransfers() {
    ...
    const {
        ...
        errors,
        credit
    } = useRetailerChildrenCreditTransfer({ any, id });
