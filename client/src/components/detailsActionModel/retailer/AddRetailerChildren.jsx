import useCreateRetailerChildren from "../../../hooks/admin/chileduser/retailers/useCreateRetailerChildren";
import { ScaleLoader } from "react-spinners";
import { useNavigate } from "react-router-dom";

export default function AddRetailerChildren({ adminParent }) {
    const {
        register,
        handleSubmit,
        onSubmit,
        ...
        states,
        cities
    } = useCreateRetailerChildren(adminParent);
            ...
            <div className="col-md-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-body">
                        <h6 className="card-title">Add Player</h6>
