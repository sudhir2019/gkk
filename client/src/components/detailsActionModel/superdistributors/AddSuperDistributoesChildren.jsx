import useCreateSuperDistributoesChildren from "../../../hooks/admin/chileduser/superdistributors/useCreateSuperDistributoesChildren";
import { ScaleLoader } from "react-spinners";
import { useNavigate } from "react-router-dom";

export default function AddSuperDistributoesChildren({ adminParent }) {
    const {
        register,
        handleSubmit,
        onSubmit,
        ...
        states,
        cities
    } = useCreateSuperDistributoesChildren(adminParent);
            ...
            <div className="col-md-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-body">
                        <h6 className="card-title">Add Area Manager</h6>
