...
import useUpdateSuperDistributoesChildren from "../../../hooks/admin/chileduser/superdistributors/useUpdateSuperDistributoesChildren";
import { ScaleLoader } from "react-spinners";

export default function EditSuperDistributoesChildren() {
    ...
    const {
        ...
        states,
        cities,
    } = useUpdateSuperDistributoesChildren({ any, id });
    return (
        <div className="row">
