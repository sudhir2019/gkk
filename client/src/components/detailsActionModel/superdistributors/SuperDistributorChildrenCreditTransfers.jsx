...
import useSuperDistributorChildrenCreditTransfer from "../../../hooks/admin/chileduser/superdistributors/useSuperDistributorChildrenCreditTransfer"; // Adjust path as necessary
import { ScaleLoader } from "react-spinners"
export default function SuperDistributorChildrenCreditTransfers() {
    ...
    const {
        ...
        errors,
        credit
    } = useSuperDistributorChildrenCreditTransfer({ any, id });
