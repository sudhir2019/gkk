...
import useSuperDistributorChildrenCreditAdjust from "../../../hooks/admin/chileduser/superdistributors/useSuperDistributorChildrenCreditAdjust";
import { ScaleLoader } from "react-spinners";

export default function SuperDistributorChildrenCreditAdjust() {
    ...
    const {
        ...
        errors,
        credit
    } = useSuperDistributorChildrenCreditAdjust({ any, id });
