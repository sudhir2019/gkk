...
import useAdminChildrenCreditTransfer from "../../../hooks/admin/chileduser/admin/useAdminChildrenCreditTransfer"; // Adjust path as necessary
import { ScaleLoader } from "react-spinners"
export default function AdminChildrenCreditTransfers() {
    ...
    const {
        ...
        errors,
        credit
    } = useAdminChildrenCreditTransfer({ any, id });
