import useCreateAdminChildren from "../../../hooks/admin/chileduser/admin/useCreateAdminChildren";
import { ScaleLoader } from "react-spinners";
import { useNavigate } from "react-router-dom";

export default function AddAdminChildren({ adminParent }) {
    const {
        register,
        handleSubmit,
        onSubmit,
        ...
        states,
        cities,
    } = useCreateAdminChildren(adminParent);
            ...
            <div className="col-md-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-body">
                        <h6 className="card-title">Add Super Area Manager</h6>
                        <form className="forms-sample" onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
                            <div className="row">
                                ...
                                {/* Role (Hidden) */}
                                <input type="hidden" {...register("role")} value="superareamanager" />
                                ...
                                {/* Role (Hidden) */}
                                <input type="hidden" {...register("role")} value="superdistributor" />
                                ...
                                <div className="col-sm-6 pt-3">
                                    <div className="form-group">
                                        ...
                                        <div className="d-flex gap-3">
                                            <label><input type="radio" {...register("userStatus")} value="true" defaultChecked /> Active</label>
                                            <label><input type="radio" {...register("userStatus")} value="false" /> Deactive</label>
                                        </div>
                                    </div>
                                </div>
                                {/* Buttons */}
