...
import useDistributorChildrenCreditAdjust from "../../../hooks/admin/chileduser/distributors/useDistributorChildrenCreditAdjust";
...
export default function SuperDistributorChildrenCreditAdjust() {
    ...
    const {
        ...
        errors,
        credit
    } = useDistributorChildrenCreditAdjust({ any, id });
