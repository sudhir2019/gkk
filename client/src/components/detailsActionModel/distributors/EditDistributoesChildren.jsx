...
import useUpdateDistributoesChildren from "../../../hooks/admin/chileduser/distributors/useUpdateDistributoesChildren";
import { ScaleLoader } from "react-spinners";

export default function EditDistributoesChildren() {
    ...
    const {
        ...
        states,
        cities,
    } = useUpdateDistributoesChildren({ any, id });
    return (
        <div className="row">
            <div className="col-md-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-body">
                        <h6 className="card-title">Edit Master</h6>
                                ...
                                <div className="col-sm-6">
                                    <div className="form-group">
                                        ...
                                        <select className="form-control" {...register("refId", { required: "Reference is required" })}>
                                            ...
                                            {distributors?.length > 0 ? distributors.map((obj) => (
