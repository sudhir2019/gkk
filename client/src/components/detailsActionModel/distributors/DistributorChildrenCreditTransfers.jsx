...
import useDistributorChildrenCreditTransfer from "../../../hooks/admin/chileduser/distributors/useDistributorChildrenCreditTransfer"; // Adjust path as necessary
import { ScaleLoader } from "react-spinners"
export default function DistributorChildrenCreditTransfers() {
    ...
    const {
        ...
        errors,
        credit
    } = useDistributorChildrenCreditTransfer({ any, id });
    const creditBalance = credit === undefined ? "0" : credit?.[0]?.walletBalance || 0;
    return (
        <div className="row">
            <div className="col-md-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-header">
                        <h6>Master Credit Transfer</h6>
                    </div>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="form-group d-flex">
                                <div className="col-sm-4 offset-lg-3">
                                    ...
                                    <br />
                                    <h4 className="breadcrumb  bg-slate-700 text-white">
                                    Hierarchy Credit: {creditBalance.toFixed(2)}
                                    </h4>
                                </div>
                            </div>
                            <div className="form-group d-flex">
